    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        ...
        <div class="card card-flush py-4">
            ...
            <div class="card-body pt-5">
                <!--begin::Form-->
                {!! Form::open(['route' => 'roles.store', 'method' => 'POST','id'=>'kt_ecommerce_settings_general_form', 'class' => 'form fv-plugins-bootstrap5 fv-plugins-framework validate_form_role',]) !!}
                <!--begin::Input group-->
                ...
                <div class="fv-row mb-7 fv-plugins-icon-container">
                    ...
                    <label class="mt-3">{{ Form::checkbox('permission[]', $value->id, false, ['class' => 'form-check-input name','data-parsley-required'=>'true' ,'data-parsley-required-message'=>'Please Select Permission.','data-parsley-errors-container'=>'#permission_error','data-parsley-trigger'=> 'click']) }}
                        {{ $value->name }}</label>
                    <br />
                    @endforeach
