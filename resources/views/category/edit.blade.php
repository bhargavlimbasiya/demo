    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        ...
        <div class="card card-flush py-4">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <!--begin::Form-->
                {!! Form::open([ 'method' => 'POST', 'route' => ['categories.update', $category->id], 'id'=>'user_form', 'class' => 'form validate_form_role', 'enctype' => 'multipart/form-data' ]) !!}
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 fv-row">
                                        <input type="text" name="name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Name" value="{{ $category->name }}" data-parsley-required data-parsley-required-message="Please enter name" data-parsley-pattern= '^[a-zA-Z_ ]*$' data-parsley-pattern-message='Please add in correct name' ,data-parsley-trigger='keyup'/>
